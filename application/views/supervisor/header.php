...
<head>
  ...
  <title>SUPERVISOR | Nursing Management System</title>
...
<div class="wrapper">
 ...
 <!--Supervisor Patient Progress Report -->
<li class="treeview">
  <a href="#">
  ...
  <ul class="treeview-menu">
    <li><a href="<?php echo base_url('PatientProgressController/manage_supervisor'); ?>"><i class="fa fa-circle-o"></i> Manage Patient Progress Report</a></li>
    <li><a href="<?php echo base_url('PatientProgressController/history_supervisor'); ?>"><i class="fa fa-circle-o"></i> Patient Progress Report History</a></li>
  </ul>
</li>
